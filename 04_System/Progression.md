# Progression
## Tiers
The strength of a Wielder or an Arcane beast is mainly shown by their tier. These [[Tiers Index]] represent the overall level of power a being possesses. Advancing within a Tier is generally easier than breaking through to the next one. Higher Tiers contain more Ranks and require significantly greater effort to progress through. The tiers go in the following order:
- [[Copper Tier]]
- [[Iron Tier]]
- [[Silver Tier]]
- [[Gold Tier]]
...
## Breakthroughs
A breakthrough occurs when a Wielder surpasses the Peak stage of a Tier and advances to the next one.
Unlike normal Rank progression, breakthroughs require sufficient Sensing, Manipulation, and alignment with the Wielder's Path. As a result, they are often considered the greatest obstacle in a Wielder's progression.